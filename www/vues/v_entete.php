                ...
                <div class="row vertical-align">
                    ...
                    <div class="col-md-8">
                        <ul class="nav nav-pills pull-right couleur" role="tablist">
                            ...
                            <li <?php if ($uc == 'gererFrais') { ?>class="active"<?php } ?>>
                                <a style="color : orange" href="index.php?uc=validerFrais&action=selectionnerMois">
                                    <span class="glyphicon glyphicon-pencil"></span>
                                    Valider la fiche de frais
                                </a>
                            </li>
                            <li <?php if ($uc == 'etatFrais') { ?>class="active"<?php } ?>>
                                <a style="color : orange" href="index.php?uc=suivrePaiement&action=selectionnerMois">
                                    <span class="glyphicon glyphicon-list-alt"></span>
